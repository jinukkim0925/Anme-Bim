...
public class zz extends aframe{
	...
	public TrayIcon t = new TrayIcon(im, "이거 누르면 안메",createpop());
	...
	public PopupMenu createpop() {
		PopupMenu pop = new PopupMenu();
		MenuItem m1 = new MenuItem("안호");
		MenuItem m2 = new MenuItem("안메");
		MenuItem m3 = new MenuItem("디지몬");
		MenuItem m4 = new MenuItem("워싱턴");
